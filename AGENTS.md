...
- 작업 지시만 넘어오면 **본 하네스를 우선**한다 (`.cursorrules` = Cursor 자동, `AGENTS.md` = Codex, `WhereHere_HARNESS.md`는 동일 내용 복사본).
...
- AI: Anthropic Codex API (Codex-sonnet-4-20250514) — Edge Function에서 호출
