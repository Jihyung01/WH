-- ============================================
-- Description: Mark RPCs
--   - public.create_mark(...)
--   - public.get_nearby_marks(...)
--   - public.get_my_marks(...)
--   - public.get_today_mark_count()
...
DECLARE
  ...
  v_emoji_icon       text := coalesce(nullif(btrim(p_emoji_icon), ''), '📍');
  v_music            jsonb;
